...
import dagshub
dagshub.init(repo_owner='huzaifa776', repo_name='Network-Security--End-to-End-ML-Project-', mlflow=True)

# Set MLflow tracking credentials from environment variables
...
class ModelTrainer:
    ...
    def track_mlflow(self,best_model,classificationmetric,best_model_name=None):
        mlflow.set_registry_uri("https://dagshub.com/huzaifa776/Network-Security--End-to-End-ML-Project-.mlflow")
